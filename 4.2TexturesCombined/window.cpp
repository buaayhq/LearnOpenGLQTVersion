...
,pTexture1(nullptr),pTexture2(nullptr)
{
...
//  connect(context(), SIGNAL(aboutToBeDestroyed()), this, SLOT(teardownGL()), Qt::DirectConnection);
  ...
  //添加顶点着色器
  pShaderProgram->addShaderFromSourceFile(QOpenGLShader::Vertex, "4.2.texture.vs");
  //添加片段着色器
  pShaderProgram->addShaderFromSourceFile(QOpenGLShader::Fragment, "4.2.texture.fs");
